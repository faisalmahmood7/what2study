...
var IFrame = function (props) {
    ...
    var _g = React.useState(), styles = _g[0], setStyles = _g[1];
...
var Main = function (props) {
    ...
    var _c = React.useState(true), toggleSound = _c[0], setTogSound = _c[1];
    ...
    var _d = React.useState(''); _d[0]; var setValue = _d[1];
    var _e = React.useState(false), dummyValuesSet = _e[0], setDummyValueCounter = _e[1];
    ...
    var _j = React.useState(false), isInputFocused = _j[0], setIsInputFocused = _j[1];
    var _k = React.useState(false), isMicPressed = _k[0], setMic = _k[1];
    var _l = React.useState(true), browserNotSupp = _l[0], setBrowserSupp = _l[1];
    var _m = React.useState(""); _m[0]; _m[1];
    var _o = React.useState(clientConfig.AudioNarration), isBotVolumeOn = _o[0], setIsBotVolumeOn = _o[1];
    var _p = React.useState(window.speechSynthesis.getVoices()), voices = _p[0], setVoices = _p[1];
    var _q = React.useState(); _q[0]; var setEnVoices = _q[1];
    var _r = React.useState(); _r[0]; var setDeVoices = _r[1];
    React.useEffect(function () {
    ...
    var _s = React.useState(glowCSS); _s[0]; _s[1];
    var _t = React.useState(false), regen = _t[0], setRegen = _t[1];
    var _u = React.useState(""), message = _u[0], setMessage = _u[1];
    React.useEffect(function () {
